...
L["%s is added to the award list"] = "%s 已经被加入计分名单，仅下次加分生效一次。"
L["%s is already in the award list"] = "%s 已经在计分名单中。"
-- L["%s is dead. Award EP?"] = true
-- L["%s is not eligible for EP awards"] = true
L["%s is now removed from the award list"] = "%s 已被移出计分名单，重新密语以加入。"
